...
class JogadorController {
    ...
    async update(req: Request, res: Response){
        ...
        const {nickname, endereco, patente} = req.body;//extrai os atributos nickname e endereco do corpo da mensagem.
        ...
        const patenteExists = await getRepository(Patente).findOne({where : {"id" : patente.id}});//consulta na tabela se existe um registro com o mesmo endereco da mensagem.
        
        if(!nicknameExists || !enderecoExists || !patenteExists){
